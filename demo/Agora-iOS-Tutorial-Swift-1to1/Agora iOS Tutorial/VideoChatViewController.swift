...
class VideoChatViewController: UIViewController {
    ...
    func setupVideo() {
        ...
        agoraKit.setRecordingAudioFrameParametersWithSampleRate(16000, channel: 1, mode: AgoraAudioRawFrameOperationMode.readOnly, samplesPerCall: 9600)
    }
    ...
    func joinChannel() {
        ...
        agoraKit.joinChannel(byToken: Token, channelId: "test", info: nil, uid: 0) { [unowned self] (channel, uid, elapsed) -> Void in
...
extension VideoChatViewController: AgoraRtcEngineDelegate,AgoraAudioFrameDelegate,WebSocketManagerDelegate {
